...
public:
    ...
    std::pair<Mat, Mat>
    make_contrib_cut_grad(const Mesh& msh, const typename Mesh::cell_type& cl, const testType &test_case, const hho_degree_info hdi)
    {
        auto parms = test_case.parms;
        auto level_set_function = test_case.level_set_;
        auto dir_jump = test_case.dirichlet_jump;
        ...
        Mat lc = stab_parms.kappa_1*gr_n.second + stab_parms.kappa_2*gr_p.second;
